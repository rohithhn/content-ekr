...
/** Map layout slot hints → API aspectRatio enum */
...
/**
 * Submit generate-2 task and poll until success or failure.
 * @param {string} apiKey Bearer token
 * @param {{ prompt: string, aspectRatio?: string, resolution?: "1K"|"2K"|"4K", outputFormat?: "png"|"jpg" }} opts
