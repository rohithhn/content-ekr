...
const PREPARE_SYSTEM = `You are a senior editor preparing source material for a multi-channel content studio (LinkedIn, Twitter/X, blog, long articles, landing pages).
...
- Channel notes should reflect format constraints (e.g. Twitter length, LinkedIn professional tone, blog SEO depth, landing conversion sections).
